...
public:
    ...
    glm::dvec3 position;
    glm::dvec3 color;
    double specularPower = 2000000.0; // Intensity of light on specular component
    double diffusePower = 2000000.0; // Intensity of light on diffuse component
    double ambientPower = 0.5; // Intensity of light on ambient component
};
